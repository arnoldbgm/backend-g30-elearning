...
> 📸 **Captura sugerida:** pantalla de descarga de Postman (postman.com/downloads), mostrando los botones de descarga para Windows/Mac/Linux.
...
> 📸 **Captura sugerida:** interfaz principal de Postman con una petición GET armada, señalando el selector de método, la barra de URL y el botón "Send".

> 📸 **Captura sugerida:** pestaña "Body" → "raw" → "JSON" seleccionada, con un JSON de ejemplo escrito.
...
> 📸 **Captura sugerida:** Postman con método POST seleccionado, pestaña Body → raw → JSON activa, mostrando un JSON de ejemplo cargado y el botón Send resaltado.
...
> 📸 **Captura sugerida:** zona de respuesta de Postman resaltando el código de estado (ej. "200 OK" en verde) en la esquina superior derecha.
